...
public class FullwidthUrlHelper implements IHelper {
    @Override
    public String getHelperTabCaption() { return "全角URL编码"; }
    ...
    public void doHelp(Map<String, Object> customArgs, IResultOutput resultOutput) throws Throwable {
        ...
        resultOutput.successPrintln(GhostBits.fullwidthUrlEncode(text));
    }
}
