...
public class JettyHexHelper implements IHelper {
    @Override
    public String getHelperTabCaption() { return "Jetty Hex编码"; }
    ...
    public void doHelp(Map<String, Object> customArgs, IResultOutput resultOutput) throws Throwable {
        ...
        resultOutput.successPrintln(GhostBits.jettyHexEncode(text));
    }
}
